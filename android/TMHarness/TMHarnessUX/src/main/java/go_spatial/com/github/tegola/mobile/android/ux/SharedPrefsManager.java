...
public class SharedPrefsManager {
    ...
    public interface Strings {
        ...
        String TM_CONFIG_TOML__LOCAL__SELECTION = "TM_POSTGIS_LOCAL_CONFIG_TOML__SELECTION";
        String TM_CONFIG_TOML__REMOTE__SELECTION = "TM_POSTGIS_REMOTE_CONFIG_TOML__SELECTION";
    ...
    public enum STRING_SHARED_PREF {
        ...
        , TM_POSTGIS_LOCAL_CONFIG_TOML__SELECTION
        , TM_POSTGIS_REMOTE_CONFIG_TOML__SELECTION
        ...
        public String toString() {
            switch (this) {
                ...
                case TM_POSTGIS_LOCAL_CONFIG_TOML__SELECTION: return Strings.TM_CONFIG_TOML__LOCAL__SELECTION;
                case TM_POSTGIS_REMOTE_CONFIG_TOML__SELECTION: return Strings.TM_CONFIG_TOML__REMOTE__SELECTION;
